...
namespace NavMeshPlus.Components.Editors
{
    ...
    class NavMeshSurfaceEditor : Editor
    {
        ...
        // // set the handle colors to be more visible in the scene view - by shir
        // static Color s_HandleColor         = new Color(127f, 214f, 244f,  20f) / 255;
        // static Color s_HandleColorSelected = new Color(127f, 214f, 244f,  60f) / 255; // בחירה מעט בולטת
        // static Color s_HandleColorDisabled = new Color(127f * 0.75f,
        //     214f * 0.75f,
        //     244f * 0.75f,
        //     20f) / 255;
        
        // set the handle colors to be less visible in the scene view - by shir
        static Color s_HandleColor         = new Color(200f, 200f, 200f,  15f) / 255;
        static Color s_HandleColorSelected = new Color(255f, 255f, 255f,  40f) / 255;
        static Color s_HandleColorDisabled = new Color(200f, 200f, 200f,  15f) / 255;
